    ...
    <>
      <Container fluid className="quotation-top">
        <Container fluid>
          <Row>
            <Col lg={10}>
              <h6 className="Adding__Product__Leftside">
            ...
            <Col lg={2}>
              <div className="btn-group">
                <button
                  type="button"
                  class="btn btn-sm font-weight-bold text-white btn-primary"
              ...
              <div className="minmax__Price__Head">
                ...
                <div className="input-group  w-50 minmax__Price__search">
                  ...
                  >
                    ...
                    <button
                      className="btn btn-primary ml-1  minmax__Price__search__btn"
                      type="button"
                    >
                      Clear
                    </button>
            ...
            <Col md={12}>
              <div className="table-scroll">
                <Table striped bordered hover className="quotation-table">
                  <thead className="Add__Pro__table__head">
                    <tr>
                      <th>Image</th>
                      <th>Item Code </th>
                      <th>Category</th>
...
export default AddProductQuotes;
