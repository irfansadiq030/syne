    ...
    <>
     <Container className="quotation-top  mt-100">
        <Container fluid>
          <Row>
            <Col lg={11}>
              <h2 className="Adding__Product__Leftside f-30 text-success">
                <b>Adding Product to Invoice:</b>{" "}
            ...
            <Col lg={1}>
              <div className="btn-group">
                <button
                  type="button"
                  class="btn btn-md font-weight-bold text-white btn-primary bg-success"
            ...
            <Col md={12}>
              <div className="table-scroll">
                <Table striped bordered hover className="quotation-table ">
                  <thead className="Add__Pro__table__head bg-success text-center">
                    <tr>
                      <th>Image</th>
                      <th>Item Code </th>
                      <th>Category</th>
