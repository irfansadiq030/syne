...
const DatabaseCompanyShowHideEditFields = () => {
  ...
  return (
    <Row>
      ...
      <Col xs={12} md={10} className="m-0 p-4 mt-5 pt-5">
        <div id="TD12">
          <h2 id="TD2">Show/Hide Company Edit Fields <i className="fas fa-bars opener ml-5"></i></h2>
          <p id="TD3">
...
export default DatabaseCompanyShowHideEditFields;
